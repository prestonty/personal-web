      ...
      <div className="bg-black text-white font-regular font-work-sans">
        ...
        >
          ...
          <p className="mx-auto max-w-3xl text-center text-sm sm:text-base md:text-lg lg:text-xl font-normal text-balance">
            ...
            universities, but it slowly evolved into a strange obsession. I’m
            aiming to visit all the major Canadian universities through their
            hackathons before I graduate. So far I’ve been to:
          </p>
          ...
          <p className="text-center 2xs:text-xs xs:text-xs sm:text-sm md:text-sm lg:text-lg xl:text-xl font-normal mt-12">
            My current career interests focus on learning backend engineering,
            including scalable system design, database architecture, and machine
            learning infrastructure. In my free time, I practice martial arts,
            play casual badminton, run long distances, and rummage for vintage
            video games.
          </p>
        </section>
        {/* HOME END ------------------------------------------------------- */}
        ...
        >
          <h2 className="text-center font-semibold text-6xl" id="#projects">
            Projects
          </h2>
